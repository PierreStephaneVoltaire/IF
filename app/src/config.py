...
DISCORD_MAX_CONTENT_CHARS = int(os.getenv("DISCORD_MAX_CONTENT_CHARS", "4000"))
DISCORD_MAX_ATTACHMENTS_PER_MESSAGE = int(os.getenv("DISCORD_MAX_ATTACHMENTS_PER_MESSAGE", "10"))
...
CLASSIFICATION_RETRY_MAX = int(os.getenv("CLASSIFICATION_RETRY_MAX", "1"))
...
EXECUTION_REGISTRY_TTL_STATE_SECONDS = int(os.getenv("EXECUTION_REGISTRY_TTL_STATE_SECONDS", str(7 * 24 * 3600)))
EXECUTION_REGISTRY_TTL_OUTBOX_SECONDS = int(os.getenv("EXECUTION_REGISTRY_TTL_OUTBOX_SECONDS", str(2 * 3600)))
EXECUTION_REGISTRY_TTL_BATCH_SECONDS = int(os.getenv("EXECUTION_REGISTRY_TTL_BATCH_SECONDS", str(24 * 3600)))
EXECUTION_REGISTRY_TTL_TASK_SECONDS = int(os.getenv("EXECUTION_REGISTRY_TTL_TASK_SECONDS", str(7 * 24 * 3600)))
EXECUTION_REGISTRY_TTL_RUN_SECONDS = int(os.getenv("EXECUTION_REGISTRY_TTL_RUN_SECONDS", str(24 * 3600)))
...
ACTIVE_TASK_STALE_HOURS = float(os.getenv("ACTIVE_TASK_STALE_HOURS", "4.0"))
...
IF_WEBHOOKS_TABLE_NAME = os.getenv("IF_WEBHOOKS_TABLE_NAME", "if-webhooks")
