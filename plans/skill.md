...
export const path_to_script_2 = "examples/01_standalone_sdk/03_activate_skill.py"

export const path_to_script_1 = "examples/01_standalone_sdk/43_mixed_marketplace_skills/main.py"

export const path_to_script_0 = "examples/05_skills_and_plugins/03_managing_installed_skills/main.py"
